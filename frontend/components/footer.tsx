                        ...
                        <div className="container footer--container media">
                            <div className="footer--block ">
                                <a className="logo" href="">
                                    <img className="logo--image" src="https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/themes/3617585/settings_images/O14Sjd9QSvma4oiA4RfT_file.jpg" alt="Footer Logo" />
                                </a>
                            </div>
                            <div className="footer--block ">
                                <span>
