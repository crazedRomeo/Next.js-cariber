...
import { SaleCourse } from "../static/interface"

export default function Sale({ yearlySubscriptionImage, yearlySubscriptionImageMobile, singleCoursePersonalImage }: SaleCourse) {
  return (
