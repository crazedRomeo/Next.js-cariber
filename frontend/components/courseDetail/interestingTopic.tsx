...
import { InterestingTopicCourse } from "../static/interface"

export default function InterestingTopic({ interestingTopics }: { interestingTopics: InterestingTopicCourse[] }) {
  return (
